...
"config.emptyExtensions": "暂无已安装扩展。",
  ...
  "settings.singleInstanceDesc": "开启后再次打开 PiDeck 会唤起已有窗口（含托盘隐藏），不会再开新进程。关闭后允许同时运行多个实例。修改后需重启生效。",
...
"config.emptyExtensions": "No installed extensions.",
  ...
  "settings.singleInstanceDesc": "When enabled, opening PiDeck again focuses the existing window (including tray-hidden) instead of starting a new process. Disable to allow multiple instances. Restart required.",
