...
- **1900EasonJin** ([@1900EasonJin](https://github.com/1900EasonJin)) — 飞书/Lark 远程控制集成、记忆管理卡片、Thinking 节流优化、侧栏卡片化重设计、草稿本浮层、终端乱码修复 (#80, #74, #60, #44, #42, #35, #34, #18)
- **zx3022448** ([@zx3022448](https://github.com/zx3022448)) — 模型列表拉取优化及错误状态展示 (#19)
